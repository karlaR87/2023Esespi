...
public class Registro extends javax.swing.JFrame {
    ...
    { 
        ...
        lbl1.setFont(tipoFuentes.fuente(tipoFuentes.DMSans, 1, 36));
        lbl2.setFont(tipoFuentes.fuente(tipoFuentes.DMSans, 0, 24));
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/VIsta/imagenes/blackTransparent1.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));

        lbl1.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        lbl1.setForeground(new java.awt.Color(255, 255, 255));
        lbl1.setText("REGISTRARSE");
        jPanel1.add(lbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 30, -1, 50));

        lbl2.setFont(new java.awt.Font("Arial", 0, 24)); // NOI18N
        lbl2.setForeground(new java.awt.Color(255, 255, 255));
        lbl2.setText("Datos personales ");
        jPanel1.add(lbl2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, -1, 70));
        ...
        jPanel1.add(lblRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 30, -1, 50));
         ...
         idiomas.setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
                idiomas.addComponentListener(new ComponentAdapter() {
                    ...
                    public void componentHidden(ComponentEvent e) {
                        // Acción a realizar cuando el nuevo JFrame se oculta
